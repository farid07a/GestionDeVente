...
//    private final String MONTH_ENGLISH[] = { "جانفي",  "فيفري","مارس", "أفريل", "ماي", "جوان",
//            "جويلية","أوت", "سبتمبر","أكتوبر", "نوفمبر",  "ديسمبر"  };
    private String dateFormat ="yyyy-MM-dd";// "dd-MM-yyyy";
    private int MONTH = 1;
...
//        YEAR = Integer.valueOf(toDay.split("-")[2]);
    ...
    public void showPopup(Component com, int x, int y) {
        popup.show(com, x, y);
       // System.out.println("com.raven.datechooser.DateChooser.showPopup()x="+x+"  y = "+y);
    }

    public void showPopup() {
        popup.show(textRefernce,-(getWidth()-textRefernce.getWidth()), textRefernce.getHeight());
    }
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(header, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(3, 3, 3)
                .addComponent(slide, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, 0))
        );
