    ...
    private class ComboUI extends BasicComboBoxUI {
        ...
        private void createHintText(Graphics2D g2) {
          ...
          //  g2.setColor(new Color(150, 150, 150));
           ...
           g2.drawString(combo.getLabeText(),(int)(in.left+textx), (int) (in.top + textY + ft.getAscent() - size));
         //  g2.drawString(combo.getLabeText(), (int) in.left, (int) (in.top + textY + ft.getAscent() - size));
