...
public class PasswordField extends JPasswordField {
    ...
    public PasswordField() {
        ...
        eye = new ImageIcon(getClass().getResource("/material/design/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("/material/design/eye_hide.png")).getImage();
